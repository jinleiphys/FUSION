...
|------|-------|----------------------|
| p-cd-manual | `p-cd-manual.in`, `p-cd-manual.search`, `p-cd-manual.min` | **the published reference case**, transcribed from Boxes 7 and 8 of *FRESCO: getting started* section 4: the same 12 points, the same start values (r0 = 1.0, V = 50, W = 5, W_d = 10). The manual prints the answer, making this the check against the literature rather than against the code |
